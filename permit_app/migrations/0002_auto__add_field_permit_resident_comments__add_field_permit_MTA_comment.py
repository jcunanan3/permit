...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Permit.resident_comments'
        db.add_column(u'permit_app_permit', 'resident_comments',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Permit.MTA_comments'
        db.add_column(u'permit_app_permit', 'MTA_comments',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Permit.resident_comments'
        db.delete_column(u'permit_app_permit', 'resident_comments')

        # Deleting field 'Permit.MTA_comments'
        db.delete_column(u'permit_app_permit', 'MTA_comments')
